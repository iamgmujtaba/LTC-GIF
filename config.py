...
def parse_opts():
    ...
    parser.add_argument('--spatial_size', default= 224, type=int, help='Height and width and hight of inputs')

    # Models (general)
    parser.add_argument('--model', default='xception', type=str, help='( inceptionV3 | xception | resnext | densenet)')
